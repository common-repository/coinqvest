...
class Edit_Payment_Button {
	...
	public function render_edit_payment_button_page(){
        ...
        <div class="wrap">
            ...
            <p>
	            <?php echo esc_html(__('Build the JSON object according to the Whalestack API documentation', 'coinqvest'))?>: <br><a href="https://www.whalestack.com/en/api-docs#post-checkout-hosted" target="_blank">https://www.whalestack.com/en/api-docs#post-checkout-hosted</a>
            </p>
