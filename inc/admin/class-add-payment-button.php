...
class Add_Payment_Button {
	...
	public function render_add_payment_button_page(){
        ...
        <div class="wrap">
            ...
            <p>
	            <?php echo esc_html(__('Provide a name and a JSON object, according to the Whalestack API documentation', 'coinqvest'))?>: <br><a href="https://www.whalestack.com/en/api-docs#post-checkout-hosted?utm_source=wordpress&utm_medium=<?php echo esc_html($_SERVER['SERVER_NAME'])?>" target="_blank">https://www.whalestack.com/en/api-docs#post-checkout-hosted</a>
            </p>
