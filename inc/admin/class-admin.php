...
class Admin {
	...
	public function add_plugin_admin_menu() {
		...
		add_menu_page('COINQVEST', 'Whalestack', 'manage_options', 'coinqvest', array($this, 'start_coinqvest'), $this->plugin_name_url . 'assets/images/favicon-22x22.png');
	...
	public function start_coinqvest(){
		$this->coinqvest_start = new Coinqvest_Start($this->plugin_name_url);
		$this->coinqvest_start->render_coinqvest_start_page();
	}
