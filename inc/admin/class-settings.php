...
class Settings {
	...
	public function render_settings_page() {
		...
		$return_url = isset($settings['return_url']) ? $settings['return_url'] : '';
		$cancel_url = isset($settings['cancel_url']) ? $settings['cancel_url'] : '';
        ...
        <div class="wrap">
            ...
            <h1><?php echo esc_html(__( 'Whalestack API and Global Settings', 'coinqvest' ))?></h1>

            <h3><?php echo esc_html(__( 'API Settings', 'coinqvest' ))?></h3>

            <p><a href="https://www.whalestack.com/en/api-settings" target="_blank"><?php echo esc_html(__('Get your API keys on www.whalestack.com', 'coinqvest'))?></a></p>
            ...
            <form action="<?=esc_url(admin_url('admin-post.php'));?>" method="POST" id="coinqvest_ajax_form">
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        <th scope="row"><?php echo esc_html(__('Debug Log', 'coinqvest'))?></th>
                        <td>
                            <select name="cq_debug_log" id="cq_debug_log">
                                <option value="yes" <?=($debug_log != "no") ? 'selected="selected"' : null?>><?php echo esc_html(__('Yes', 'coinqvest'))?></option>
                                <option value="no" <?=($debug_log == "no") ? 'selected="selected"' : null?>><?php echo esc_html(__('No', 'coinqvest'))?></option>
                            </select>
                            <p class="description">
                                <?php echo esc_html(__('Log Whalestack API events.', 'coinqvest'))?><br />
                            </p>
                        </td>
                    </tr>
	...
	public function submit_form_global_settings() {
        ...
        $debug_log = sanitize_text_field($_POST['cq_debug_log']);
        $is_ajax = (isset( $_POST['ajaxrequest']) && $_POST['ajaxrequest'] === 'true') ? true : false;
