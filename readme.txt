...
Add cryptocurreny payment options like Bitcoin, Litecoin, USDC, EURC, and Lightning to your WordPress website using Whalestack (formerly knows as COINQVEST). Settle in fiat or stablecoin with ease. Integrate checkouts supporting Bitcoin, USDC, EURC, and Lightning, directly into your WordPress site. Leverage our unique bank payout feature, ensuring you can effortlessly convert cryptocurrency payments into fiat or stablecoins.
...
3. Dashboard with multi-currency blockchain wallets
4. Automated invoice generation for each payment
5. Payouts to bank accounts (SEPA, SWIFT) and crypto wallets

== Changelog ==

= 2.0.2 =

* Finetuning for Whalestack

= 2.0.1 =

* Fixed PHP 8 deprecated messages

= 2.0.0 =

* Rebranding from COINQVEST to Whalestack
